...
def test_mc_euro_price_put():
    ...
    call_price = mc_euro_price(
        S0, K, T, r, sigma, n_paths=50000, seed=42, option_type="call"
    )
    put_price = mc_euro_price(
        S0, K, T, r, sigma, n_paths=50000, seed=42, option_type="put"
    )
...
def test_mc_converges_to_bs():
    ...
    mc_call_price = mc_euro_price(
        S0, K, T, r, sigma, n_paths=500_000, seed=42, option_type="call"
    )
